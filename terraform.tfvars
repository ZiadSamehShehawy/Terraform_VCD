...
vcd_pass = "VMware@!12345"                  **Hint:** Review this code in the Infrastructure folder.
...
extnet_gw = "10.250.10.1"                  **Hint:** Review this code in the Infrastructure folder.
...
extnet_ip_pool_start = "10.250.10.20"      **Hint:** Review this code in the Infrastructure folder.
extnet_ip_pool_end = "10.250.10.50"        **Hint:** Review this code in the Infrastructure folder.
